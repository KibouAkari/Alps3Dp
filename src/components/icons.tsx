...
export function CartIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      ...
      <path d="M3 4h2l2.4 10.2a2 2 0 0 0 2 1.5h7.8a2 2 0 0 0 2-1.6L21 7H7" />
    </svg>
  );
}
...
// A hamburger with a longer center bar, used for the collapsible filter
// panel toggle and the mobile sidebar drawer trigger.
export function FilterMenuIcon({ className = "h-4 w-4" }: IconProps) {
  return (
