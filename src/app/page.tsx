...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-8 immersive-rise">
      <section className="hero-shell overflow-hidden rounded-3xl border p-5 shadow-sm sm:p-10">
        <p className="text-sm uppercase tracking-[0.2em] text-sky-700">3D Print Shop</p>
        <h1 className="mt-3 max-w-3xl text-2xl font-bold tracking-tight text-slate-900 sm:text-5xl">
